...
@Module({
  controllers: [IntegrationAuthSchemeCommandController],
  providers: [
  ...
  exports: [IntegrationAuthSchemeAuthGuard, CommandBus, EventBus, UnhandledExceptionBus],
})
export class AuthIntegrationAuthSchemeModule {}
