...
import { IntegrationAuthSchemeCreatedEvent } from './integrationauthschemecreated.event';
import { IntegrationAuthSchemeUpdatedEvent } from './integrationauthschemeupdated.event';
import { IntegrationAuthSchemeDeletedEvent } from './integrationauthschemedeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'integration-auth-scheme-created': createEventDefinition('integration-auth-scheme-created', IntegrationAuthSchemeCreatedEvent, EVENT_DEFINITION_OVERRIDES['integration-auth-scheme-created']),
  'integration-auth-scheme-updated': createEventDefinition('integration-auth-scheme-updated', IntegrationAuthSchemeUpdatedEvent, EVENT_DEFINITION_OVERRIDES['integration-auth-scheme-updated']),
  'integration-auth-scheme-deleted': createEventDefinition('integration-auth-scheme-deleted', IntegrationAuthSchemeDeletedEvent, EVENT_DEFINITION_OVERRIDES['integration-auth-scheme-deleted']),
