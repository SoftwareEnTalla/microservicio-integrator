...
import { IntegrationCredentialCreatedEvent } from './integrationcredentialcreated.event';
import { IntegrationCredentialUpdatedEvent } from './integrationcredentialupdated.event';
import { IntegrationCredentialDeletedEvent } from './integrationcredentialdeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'integration-credential-created': createEventDefinition('integration-credential-created', IntegrationCredentialCreatedEvent, EVENT_DEFINITION_OVERRIDES['integration-credential-created']),
  'integration-credential-updated': createEventDefinition('integration-credential-updated', IntegrationCredentialUpdatedEvent, EVENT_DEFINITION_OVERRIDES['integration-credential-updated']),
  'integration-credential-deleted': createEventDefinition('integration-credential-deleted', IntegrationCredentialDeletedEvent, EVENT_DEFINITION_OVERRIDES['integration-credential-deleted']),
