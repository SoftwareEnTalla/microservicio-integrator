...
@Injectable()
export class IntegrationCredentialGraphqlRepository {
  constructor(
    @InjectRepository(IntegrationCredentialDto)
    private readonly repository: Repository<IntegrationCredentialDto>
  ) {}
