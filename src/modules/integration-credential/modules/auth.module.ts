...
@Module({
  controllers: [IntegrationCredentialCommandController],
  providers: [
  ...
  exports: [IntegrationCredentialAuthGuard, CommandBus, EventBus, UnhandledExceptionBus],
})
export class AuthIntegrationCredentialModule {}
