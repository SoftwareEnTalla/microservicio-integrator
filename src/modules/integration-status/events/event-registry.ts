...
import { IntegrationStatusCreatedEvent } from './integrationstatuscreated.event';
import { IntegrationStatusUpdatedEvent } from './integrationstatusupdated.event';
import { IntegrationStatusDeletedEvent } from './integrationstatusdeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'integration-status-created': createEventDefinition('integration-status-created', IntegrationStatusCreatedEvent, EVENT_DEFINITION_OVERRIDES['integration-status-created']),
  'integration-status-updated': createEventDefinition('integration-status-updated', IntegrationStatusUpdatedEvent, EVENT_DEFINITION_OVERRIDES['integration-status-updated']),
  'integration-status-deleted': createEventDefinition('integration-status-deleted', IntegrationStatusDeletedEvent, EVENT_DEFINITION_OVERRIDES['integration-status-deleted']),
