...
@Module({
  controllers: [IntegrationStatusCommandController],
  providers: [
  ...
  exports: [IntegrationStatusAuthGuard, CommandBus, EventBus, UnhandledExceptionBus],
})
export class AuthIntegrationStatusModule {}
