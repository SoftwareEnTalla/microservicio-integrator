...
import { IntegrationRuntimePolicyCreatedEvent } from './integrationruntimepolicycreated.event';
import { IntegrationRuntimePolicyUpdatedEvent } from './integrationruntimepolicyupdated.event';
import { IntegrationRuntimePolicyDeletedEvent } from './integrationruntimepolicydeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'integration-runtime-policy-created': createEventDefinition('integration-runtime-policy-created', IntegrationRuntimePolicyCreatedEvent, EVENT_DEFINITION_OVERRIDES['integration-runtime-policy-created']),
  'integration-runtime-policy-updated': createEventDefinition('integration-runtime-policy-updated', IntegrationRuntimePolicyUpdatedEvent, EVENT_DEFINITION_OVERRIDES['integration-runtime-policy-updated']),
  'integration-runtime-policy-deleted': createEventDefinition('integration-runtime-policy-deleted', IntegrationRuntimePolicyDeletedEvent, EVENT_DEFINITION_OVERRIDES['integration-runtime-policy-deleted']),
