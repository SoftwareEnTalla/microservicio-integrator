...
@Module({
  controllers: [IntegrationRuntimePolicyCommandController],
  providers: [
  ...
  exports: [IntegrationRuntimePolicyAuthGuard, CommandBus, EventBus, UnhandledExceptionBus],
})
export class AuthIntegrationRuntimePolicyModule {}
