...
import { logger } from '@core/logs/logger';
  ...
  @Injectable()
  export class IntegrationRuntimePolicyRepository {
    constructor(
    ...
    async findAndCount(where?: Record<string, any>): Promise<[IntegrationRuntimePolicy[], number]> {
      logger.info('Ready to findByField IntegrationRuntimePolicy on repository:',where);
    ...
    async update(
        ...
        logger.info('Updated instance of IntegrationRuntimePolicy with id:  was finded on repository:', instance);
