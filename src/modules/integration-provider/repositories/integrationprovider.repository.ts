...
import { logger } from '@core/logs/logger';
  ...
  export class IntegrationProviderRepository {
    ...
    async findAndCount(where?: Record<string, any>): Promise<[IntegrationProvider[], number]> {
      logger.info('Ready to findByField IntegrationProvider on repository:',where);
    ...
    async update(
        ...
        logger.info('Updated instance of IntegrationProvider with id:  was finded on repository:', instance);
