...
import { IntegrationProviderCreatedEvent } from './integrationprovidercreated.event';
import { IntegrationProviderUpdatedEvent } from './integrationproviderupdated.event';
import { IntegrationProviderDeletedEvent } from './integrationproviderdeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'integration-provider-created': createEventDefinition('integration-provider-created', IntegrationProviderCreatedEvent, EVENT_DEFINITION_OVERRIDES['integration-provider-created']),
  'integration-provider-updated': createEventDefinition('integration-provider-updated', IntegrationProviderUpdatedEvent, EVENT_DEFINITION_OVERRIDES['integration-provider-updated']),
  'integration-provider-deleted': createEventDefinition('integration-provider-deleted', IntegrationProviderDeletedEvent, EVENT_DEFINITION_OVERRIDES['integration-provider-deleted']),
