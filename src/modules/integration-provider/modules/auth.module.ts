...
@Module({
  controllers: [IntegrationProviderCommandController],
  providers: [
  ...
  exports: [IntegrationProviderAuthGuard, CommandBus, EventBus, UnhandledExceptionBus],
})
export class AuthIntegrationProviderModule {}
