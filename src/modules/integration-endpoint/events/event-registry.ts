...
import { IntegrationEndpointCreatedEvent } from './integrationendpointcreated.event';
import { IntegrationEndpointUpdatedEvent } from './integrationendpointupdated.event';
import { IntegrationEndpointDeletedEvent } from './integrationendpointdeleted.event';
...
export const EVENT_DEFINITIONS: Record<string, RegisteredEventDefinition> = {
  'integration-endpoint-created': createEventDefinition('integration-endpoint-created', IntegrationEndpointCreatedEvent, EVENT_DEFINITION_OVERRIDES['integration-endpoint-created']),
  'integration-endpoint-updated': createEventDefinition('integration-endpoint-updated', IntegrationEndpointUpdatedEvent, EVENT_DEFINITION_OVERRIDES['integration-endpoint-updated']),
  'integration-endpoint-deleted': createEventDefinition('integration-endpoint-deleted', IntegrationEndpointDeletedEvent, EVENT_DEFINITION_OVERRIDES['integration-endpoint-deleted']),
