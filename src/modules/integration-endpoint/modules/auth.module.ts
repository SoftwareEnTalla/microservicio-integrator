...
@Module({
  controllers: [IntegrationEndpointCommandController],
  providers: [
  ...
  exports: [IntegrationEndpointAuthGuard, CommandBus, EventBus, UnhandledExceptionBus],
})
export class AuthIntegrationEndpointModule {}
